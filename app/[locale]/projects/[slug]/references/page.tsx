...
import { ProjectReferencesDetail } from "@/components/notion/references";
import {
  findProject,
...
export default async function ProjectReferencesPage({
  ...
  return (
    <DetailPage
      backHref={localePath(locale, `/projects/${project.slug}`)}
      backLabel={getUi(locale).references.toProject}
    >
      <ProjectReferencesDetail
        project={project}
