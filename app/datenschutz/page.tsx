    ...
    <LegalPage title="Datenschutzerklärung">
      ...
      <LegalSection title="2. Überblick">
        <p>
          ...
          Formulare und ohne Werbenetzwerke. Es werden keine Cookies gesetzt.
          Schriftarten werden lokal von dieser Website ausgeliefert; beim Besuch
          wird keine Verbindung zu Google oder anderen Font-Diensten aufgebaut.
          Personenbezogene Daten fallen nur in dem unten beschriebenen, engen
          Umfang an.
        </p>
      </LegalSection>
      ...
      <LegalSection title="3. Hosting und Server-Logfiles">
        ...
        <p>
          ...
          Browsertyp). Diese Server-Logfiles dienen ausschließlich der
      ...
      <LegalSection title="4. Anonyme Reichweiten- und Interaktionsmessung">
        ...
        <p>
          ...
          keine Anwendung, da nicht auf Ihr Endgerät zugegriffen wird.
          Aggregierte Statistikdaten werden nach spätestens 14 Monaten
          gelöscht.
        </p>
        <p>
      ...
      <LegalSection title="7. Referenzen und Empfehlungen Dritter">
        <p>
          ...
          widerrufen (Kontaktdaten siehe Abschnitt 1); der Eintrag wird dann
