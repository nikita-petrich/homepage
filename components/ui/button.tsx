...
const buttonVariants = cva(
  /* Named properties rather than shadcn's `transition-all`: a button only
     changes colour, border and its focus ring, and `all` additionally armed
     every layout property — so a width or padding change anywhere animated,
