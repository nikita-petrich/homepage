...
export const projects: Project[] = [
  ...
  {
    num: "03", slug: "rate-up", name: "rate-up", company: "Krutzfeld Tech GmbH", companyUrl: "https://krutzfeld.tech", subtitle: "Bewertungs-App für Web, iOS und Android",
    ...
    aufgaben: [
      "Bewertungs-App im Social-Media-Umfeld aus einer einzigen Ionic-/Angular-Codebasis für Web, iOS und Android.",
      "Registrierung, Login und Onboarding inklusive Profilerstellung (Firebase Authentication).",
      "Social-Media-Feed mit Filtern, eigenen Beiträgen und Media-Upload (Cloud Firestore, Cloud Storage).",
      "Serverseitige Logik in Cloud Functions, Auslieferung über Firebase Hosting und eine CI/CD-Pipeline für alle drei Plattformen.",
      "Wartbare Codebasis für die Übergabe: wiederverwendbare Komponenten, typsichere Modelle, klar getrennte Services und durchgängiger Clean-Code-Stil (SOLID).",
    ],
    ergebnis: [
      "Fertiges Produkt an den Kunden übergeben – lauffähig auf Web, iOS und Android aus einer gemeinsamen Codebasis.",
    ...
    tech: ["TypeScript", "Angular", "Ionic", "RxJS", "Cross-Platform-Entwicklung", "iOS", "Android", "Responsive Design", "UI-Implementierung", "Nutzerführung", "Firebase", "Firebase Authentication", "Cloud Firestore", "Cloud Storage", "Cloud Functions", "Firebase Cloud Messaging (FCM)", "Firebase Hosting", "Authentifizierung", "Onboarding-Flows", "Social Media", "Typsicherheit", "Clean Code", "SOLID", "Separation of Concerns", "Git", "GitHub", "CI/CD", "Linux"],
  },
  {
...
export const skills: SkillCategory[] = [
  ...
  { num: "09", name: "Auth & Security", items: ["JWT", "OAuth 2.0", "Single Sign-On (SSO)", "better-auth", "Firebase Authentication", "Authentifizierung", "Role-Based Access Control (RBAC)", "Row Level Security", "SSL/TLS", "Ende-zu-Ende-Verschlüsselung", "Microsoft Entra ID (ehem. Azure Active Directory)", "Secure by Design", "IT-Sicherheit"] },
