...
export type Certificate = {
  /** Stable URL slug — the PDF lives at /zertifikate/<slug>.pdf forever, the
      detail page at /zertifikate/<slug>. */
  slug: string;
  title: string;
  ...
  /** Pre-rendered first PDF page, generated by scripts/certificate-previews.mjs
      into /public/assets/zertifikate. Set exactly for the self-hosted PDFs. */
  preview?: string;
...
export const certificates: Certificate[] = [
  {
    ...
    summary:
      "Kurs zum KI-gestützten Entwickeln mit GitHub Copilot, Cursor AI und ChatGPT: Werkzeuge und Arbeitsweisen, um KI-Assistenz vom Prompt bis zum fertigen Code in den täglichen Entwicklungs-Workflow einzubinden.",
    facts: [
      { label: "Umfang", value: "5,5 Std." },
      { label: "Sprache", value: "Englisch" },
      { label: "Format", value: "Video-Kurs" },
  ...
  },
  {
    ...
    summary:
      "Projektkurs von Mosh Hamedani zum Bauen von LLM-Anwendungen: von den Grundlagen der Sprachmodelle über ein modernes Full-Stack-Setup bis zu zwei durchgehenden Projekten — einem KI-Chatbot und einem Recipe Recommender — inklusive Prompt Engineering und dem Arbeiten mit Open-Source-Modellen. Vollständig abgeschlossen (alle Lektionen).",
    facts: [
  ...
  },
  {
    ...
    preview: "/assets/zertifikate/angular-real-world-guide.webp",
    courseUrl:
  ...
  },
  {
    ...
    preview: "/assets/zertifikate/the-ai-engineer-path.webp",
    summary:
      "Scrimbas Lernpfad zum AI Engineer, durchgehend interaktiv im Browser-Editor. Der Pfad führt von den ersten API-Requests an ein Sprachmodell über Context Engineering und eine von Hand gebaute RAG-Pipeline (Embeddings, Text-Splitting, Vektordatenbank) zu Agenten mit dem Vercel AI SDK — Tool Calling, strukturierte Outputs, agentisches Retrieval-Routing und Websuche — und schließt mit einem eigenen MCP-Server und Multimodalität (Bildgenerierung und Vision) ab.",
    facts: [
      { label: "Umfang", value: "8,2 Std." },
      { label: "Lektionen", value: "142 Scrims in 5 Modulen" },
      { label: "Sprache", value: "Englisch" },
    ...
    outcomes: [
      ...
      "Context Engineering: Kontext und Prompts so aufbereiten, dass Antworten verlässlich und reproduzierbar werden",
      "RAG von Grund auf: Embeddings, Text-Splitting, Dokumente in eine Vektordatenbank einbetten und wieder abrufen",
      "Vercel AI SDK: Basics, strukturierte Outputs und Tool Calling — jeweils mit eigener Challenge",
      "Agenten: agentisches Retrieval-Routing, Web-Search-Agent und die Kombination aus Websuche und Retrieval zum vollständigen Customer-Support-Agenten",
    ...
    curriculum: [
      ...
      { title: "Context Engineering", meta: "58 Min." },
      {
        title: "Vercel AI SDK",
    ...
    curriculumNote:
      "Module des Lernpfads mit den auf der Kursseite gelisteten Lektionen. Das Zertifikat weist insgesamt 142 Scrims aus — die Challenge- und Solution-Scrims innerhalb der Lektionen sind hier nicht einzeln aufgeführt.",
  },
  {
    slug: "learn-python",
    title: "Learn Python",
    ...
    cat: "Python",
    tags: ["Grundlagen"],
    preview: "/assets/zertifikate/learn-python.webp",
    summary:
  ...
  },
  {
    ...
    preview: "/assets/zertifikate/learn-accessible-web-design.webp",
    summary:
  ...
  },
  {
    ...
    summary:
      "Umfassender Python-Kurs von Mosh Hamedani, von den Sprachgrundlagen über Datenstrukturen und objektorientierte Programmierung bis zu Standardbibliothek und Paketen. Vollständig abgeschlossen (alle Lektionen).",
    facts: [
      { label: "Dozent", value: "Mosh Hamedani" },
      { label: "Sprache", value: "Englisch" },
      { label: "Format", value: "Video-Kurs mit Übungen" },
      { label: "Fortschritt", value: "100 % abgeschlossen" },
