...
export const projects: Project[] = [
  {
    ...
    aufgaben: [
      ...
      "Entwicklung der KI-Vorprüfungs-Pipeline für Bescheide und Kündigungen: Extraktion → Fristprüfung → Plausibilitäts- und Erfolgseinschätzung mit strukturierter Aufbereitung des Falls.",
    ...
    ergebnis: [
      "MVP in Eigenregie umgesetzt – Architektur, KI-Vorprüfung und Betrieb auf EU-Infrastruktur aus einer Hand.",
  ...
  },
  {
    ...
    aufgaben: [
      "Produktive KI-Anreicherung anwaltlicher Erstgespräch-Leads: Aufzeichnungen werden per Bluedot transkribiert und über Webhook und BullMQ-Queue an die OpenAI-Integration übergeben.",
      ...
      "Konsolidierung von vier Portalen (B2B, B2C, Lawyer, Ops) in ein einheitliches „B2X“-Portal – verantwortlich für die Fullstack-Migration der B2B- und Ops-Bereiche.",
  ...
  },
  {
    ...
    ergebnis: [
      "Voll funktionsfähiges MVP-Frontend in zwei Monaten – eigenständig von Konzept bis Demo.",
  ...
  },
  {
    ...
    aufgaben: [
      "Digitale Vorgangsverwaltung im Notarportal: strukturierte Datenerfassung, digitale Verfahrensakten und nahtlose interne Ablage.",
      ...
      "Qualitätssicherung im Frontend: Code-Reviews und Verbesserung der Codebasis auf Eigeninitiative.",
    ],
    ergebnis: [
  ...
  },
  {
    ...
    ergebnis: [
      "Laut Kunde bis zu 40 Stunden weniger Verwaltungsarbeit pro Monat (bis zu 480 Stunden/Jahr).",
  ...
  },
  {
    ...
    cat: "Logistik & Non-Profit", role: "Sole Developer · Full-Stack & AI",
    ...
    desc: "LKW-Tourverwaltungssystem für die Hilfstransporte einer humanitären Organisation: Steuerung der Tourenplanung mit Echtzeit-Tracking und revisionssicherer Archivführung je Tour.",
    meta: [
      { label: "Rolle", value: "Sole Developer · Full-Stack & AI" },
      { label: "Team", value: "Solo · Kundenprojekt" },
    ...
    aufgaben: [
      "Dynamische Tourenplanung mit Echtzeit-Tracking: Touren anlegen, ändern und im laufenden Betrieb nachverfolgen.",
      "Automatisierte Generierung von PDF- und DOCX-Dokumenten je Tour.",
      "Revisionssichere digitale Archivführung für jede abgeschlossene Tour.",
      "Rollenbasierte Zugriffssteuerung und sichere Authentifizierung (better-auth).",
      "Alleinverantwortung für Backend-Architektur (NestJS, Clean Architecture) und das selbst gehostete Deployment (Docker, Nginx) inkl. laufender Wartung.",
    ],
    ergebnis: [
      "Spart durch automatisierte Dokumentenprozesse laut Kunde bis zu 1.000 Stunden pro Jahr und senkt die Personalkosten spürbar.",
      "Eingetroffene Ware lässt sich deutlich schneller einlagern; die Logistikeffizienz steigt laut Kunde um bis zu 20 %.",
      "Deutlich reduzierte Übertragungsfehler durch durchgängig digitale Prozesse.",
    ],
    tech: ["TypeScript", "Node.js", "NestJS", "Next.js", "React", "Fastify", "REST API", "GraphQL", "PostgreSQL", "Redis", "MikroORM", "React Router", "Tailwind CSS", "Single Page Application (SPA)", "Logistik", "Tourenplanung", "Echtzeit-Tracking", "PDF-Generierung", "DOCX-Generierung", "Digitale Archivführung", "better-auth", "JWT", "Authentifizierung", "Role-Based Access Control (RBAC)", "Docker", "Self-Hosting", "Linux", "Ubuntu", "CI/CD", "GitHub Actions", "Claude Code", "Cursor AI", "Model Context Protocol (MCP)", "Slack", "Nginx", "Microservices", "Clean Architecture"],
  },
  {
  ...
  },
  {
    ...
    aufgaben: [
      ...
      "Detaillierte Wartungshistorie und gerätebezogenes Dokumentenmanagement.",
    ...
    ergebnis: [
      "Mandantenfähige Geräteverwaltung für mehrere Krankenhäuser – Stammdaten, Wartungshistorie und Dokumente je Gerät an einer Stelle.",
      "Störungsmeldungen des Pflegepersonals laufen ohne Umweg in den Wartungsprozess der Medizintechnik.",
      "Sauber geschichtete .NET-Architektur: Code-First-Datenmodell (Entity Framework Core, MSSQL), dokumentierte REST-API (Swagger/OpenAPI) und Anmeldung über O365 Identity.",
    ],
