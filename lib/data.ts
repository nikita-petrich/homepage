...
export const certificates: Certificate[] = [
  {
    ...
    facts: [
      { label: "Umfang", value: "8 Std. 2 Min. Video" },
      { label: "Lektionen", value: "147 in 7 Abschnitten" },
      { label: "Anbieter", value: "Academind" },
      { label: "Sprache", value: "Englisch" },
    ...
    curriculumNote:
      "Offizielle Kursgliederung: 147 Lektionen in 7 Abschnitten, Kursstand Januar 2026. Der Kurs wurde nach dem Abschluss um die aktuellen Copilot- und Cursor-Module erweitert; die als „Legacy“ gekennzeichneten Teile sind die ältere Fassung. Die Abschnittstitel sind zusammenfassend benannt.",
  },
  {
