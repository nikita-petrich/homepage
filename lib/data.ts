...
export const projects: Project[] = [
  ...
  },
  {
    ...
    aufgaben: [
      ...
      "Serverseitige Logik in Cloud Functions und Auslieferung über Firebase Hosting.",
      "CI/CD-Pipeline für alle drei Plattformen (GitHub, Linux).",
    ],
    ergebnis: [
    ...
    tech: ["TypeScript", "Angular", "Ionic", "Cross-Platform-Entwicklung", "iOS", "Android", "Firebase", "Firebase Authentication", "Cloud Firestore", "Cloud Storage", "Cloud Functions", "Firebase Cloud Messaging (FCM)", "Firebase Hosting", "Authentifizierung", "Onboarding-Flows", "Social Media", "Git", "GitHub", "CI/CD", "Linux"],
  },
  {
