...
export const skills: SkillCategory[] = [
  ...
  { num: "02", name: "Agentic Coding", items: ["Claude Code", "Cursor AI", "Code Rabbit", "GitHub Copilot", "ChatGPT", "Agentic Coding", "Context Engineering", "Agentische Pull-Request-Workflows"] },
