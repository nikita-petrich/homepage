...
export const projects: Project[] = [
  {
    ...
    ergebnis: [
      "Eigenprodukt vollständig in Eigenregie umgesetzt – Architektur, KI-Pipeline und Betrieb auf EU-Infrastruktur aus einer Hand.",
      ...
      "Zielbild: bis zu 10.000 automatisierte Vorprüfungen pro Monat und bis zu 80 % weniger manuelle Fallannahme durch KI-Intake und automatisiertes Anwalts-Routing.",
    ],
  ...
  },
  {
    ...
    ergebnis: [
      "Mandantenfähige Geräteverwaltung über mehrere Krankenhäuser hinweg – Wartungshistorie und Dokumente je Gerät an einer Stelle.",
      "Störungen werden direkt vom Pflegepersonal erfasst und landen ohne Umweg bei der Medizintechnik.",
    ],
