...
export const projects: ProjectSource[] = [
  ...
  },
  {
    ...
    tech: techList([
      "TypeScript", "Python", "Next.js", "React", "NestJS", "Node.js", "Fastify",
      "Express.js", "REST API", "Webhooks", "DTOs", "BullMQ", "RabbitMQ",
      "LLM-Integration", "OpenAI API", "Anthropic Claude API",
      "Model Context Protocol (MCP)", "Bluedot", "HubSpot", "Cal.com",
      "Amplitude", "PostgreSQL", "Redis", "MikroORM", "TanStack Query",
  ...
  },
  {
    ...
    tech: techList([
      "TypeScript", "Angular", "Ionic", "Capacitor", "RxJS",
      "Cross-Platform-Entwicklung", "iOS", "Android",
      "Progressive Web App (PWA)", "Responsive Design", "UI-Implementierung",
      "Nutzerführung", "Firebase", "Firebase Authentication",
