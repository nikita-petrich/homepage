...
export const projects: ProjectSource[] = [
  {
    ...
    tech: techList([
      ...
      "Tailwind CSS", "shadcn/ui", "Komponentenbibliotheken", "Design Tokens",
      "Wireframing", "Internationalisierung (i18n)",
      ...
      "Continuous Integration", "DevOps", "Hetzner", "EU-Hosting", "Linux",
      "Ubuntu", "Sentry", "Monitoring", "Observability", "Vitest",
      "Playwright", "Unit Testing", "Integrationstests", "End-to-End-Tests",
      "API-Testing", "Postman", "Testautomatisierung", "Zod", "DTOs", "Slack",
      "Husky", "pnpm", "Software-Architektur", "API-First", "Middleware",
      "Design Patterns", "Microservices", "Clean Code", "SOLID",
