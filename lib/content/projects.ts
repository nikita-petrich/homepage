...
export const projects: ProjectSource[] = [
  {
    ...
    tech: techList([
      ...
      "Next.js", "React", "Server-Side Rendering (SSR)", "FastAPI",
      "Backend-Entwicklung", "Frontend-Entwicklung", "Web-Entwicklung",
      "Künstliche Intelligenz", "GenAI", "AI Engineering", "LLM-Integration",
      "OpenAI API", "Azure OpenAI", "RAG (Retrieval Augmented Generation)",
      "Prompt Engineering", "Embeddings", "Vektordatenbanken", "pgvector",
      "Semantische Suche", "OCR", "Dokumentenanalyse", "LangChain",
      "KI-gestützte Automatisierung", "DSGVO-konforme KI-Architektur",
      "PostgreSQL", "Redis", "Tailwind CSS", "shadcn/ui",
      "Komponentenbibliotheken", "Internationalisierung (i18n)",
      "Barrierefreiheit (WCAG)", "Stripe", "Zahlungsabwicklung", "JWT",
      "OAuth 2.0", "Secure by Design", "Docker", "GitHub Actions", "CI/CD",
      "Continuous Integration", "Hetzner", "EU-Hosting", "Linux", "Ubuntu",
      "Sentry", "Monitoring", "Observability", "Vitest", "Playwright",
      "Unit Testing", "End-to-End-Tests", "Testautomatisierung", "Zod", "DTOs",
      "Slack", "Husky", "Software-Architektur", "Microservices",
      "Clean Architecture", "MVP-Entwicklung", "SaaS", "Kanzleisoftware",
      "Prozessdigitalisierung", "Clean Code", "SOLID", "EU AI Act", "DSGVO", "Privacy by Design",
      "Digitale Souveränität", "Softwareentwicklung", "Produktverantwortung",
      "Entrepreneurship",
    ]),
  },
  {
    ...
    tech: techList([
      ...
      "PostgreSQL", "Redis", "MikroORM", "TanStack Query", "better-auth", "JWT",
      "Docker", "Linux", "Ubuntu", "Google Cloud Platform (GCP)", "Vercel",
      ...
      "Slack", "Husky", "Monorepo", "Turborepo", "Microservices",
  ...
  },
  {
    ...
    tech: techList([
      ...
      "Social Media", "Typsicherheit", "Unit Testing", "Clean Code", "SOLID",
      "Separation of Concerns", "Clean Architecture", "MVP-Entwicklung", "Git",
      "GitHub", "npm", "Trello", "GitHub Actions", "CI/CD",
      "Continuous Integration", "Linux", "Softwareentwicklung",
    ]),
  },
  {
    num: "04",
    ...
    tech: techList([
      ...
      "shadcn/ui", "JWT", "Authentifizierung", "Docker", "Linux", "Ubuntu",
      "Vercel", "CI/CD", "GitHub Actions", "Continuous Integration", "Vitest",
      "Unit Testing", "npm", "Cursor AI", "Model Context Protocol (MCP)",
      "Agentic Coding", "MVP-Entwicklung", "Clean Code", "SOLID",
      "Clean Architecture", "Softwareentwicklung",
    ]),
  },
  {
    num: "05",
    ...
    tech: techList([
      ...
      "Nginx", "Linux", "Ubuntu", "GitLab", "npm", "Slack", "Clean Architecture",
  ...
  },
  {
    ...
    tech: techList([
      ...
      "REST API", "GraphQL", "DTOs", "Typsicherheit", "Backend-Entwicklung",
      ...
      "Datenmodellierung", "Warenwirtschaft", "Lagerverwaltung", "Buchhaltung",
      "Rechnungsstellung", "Auftragsverwaltung", "Stammdatenverwaltung",
      "PDF-Generierung", "ERP", "GoBD", "Revisionssicherheit",
      "Prozessdigitalisierung", "better-auth", "JWT",
      "Role-Based Access Control (RBAC)", "SSL/TLS", "Docker", "Docker Compose",
      "Self-Hosting", "Linux", "Ubuntu", "Monitoring", "Observability", "CI/CD",
      "Continuous Integration", "GitHub", "GitHub Actions", "Husky", "npm",
      ...
      "Clean Code", "SOLID", "Clean Architecture", "Requirements Engineering", "IT-Beratung",
  ...
  },
  {
    ...
    tech: techList([
      ...
      "Single Page Application (SPA)", "Tailwind CSS", "REST API", "GraphQL",
      "Backend-Entwicklung", "Frontend-Entwicklung", "Web-Entwicklung",
      "PostgreSQL", "Redis", "Caching", "MikroORM", "Datenmodellierung",
      "Logistik", "Tourenplanung", "Auftragsverwaltung", "Dokumentenmanagement",
      "PDF-Generierung", "DOCX-Generierung", "Digitale Archivführung",
      "Prozessdigitalisierung", "Plattform-Migration", "Systemintegration",
      "better-auth", "JWT", "Authentifizierung",
      "Role-Based Access Control (RBAC)", "Docker", "Docker Compose",
      "Self-Hosting", "Linux", "Ubuntu", "Nginx", "Monitoring", "Observability",
      "CI/CD", "Continuous Integration", "GitHub Actions", "Husky", "npm",
      "Unit Testing", "Testautomatisierung", "Claude Code", "Cursor AI",
      "Model Context Protocol (MCP)", "Agentic Coding",
      "Agentische Pull-Request-Workflows", "Monorepo", "Nx", "Slack",
      "Microservices", "Clean Code", "SOLID", "Clean Architecture",
  ...
  },
  {
    ...
    tech: techList([
      "TypeScript", "JavaScript", "HTML", "CSS", "SCSS", "JSON", "YAML",
      "Angular", "NgRx", "RxJS", "Angular Material", "Komponentenbibliotheken",
      "Figma", "UI-Implementierung", "Node.js", "NestJS", "Express.js",
      "Dependency Injection", "REST API", "GraphQL", "Frontend-Entwicklung",
      "Backend-Entwicklung", "Web-Entwicklung", "MongoDB", "Mongoose", "NoSQL",
      "Datenmodellierung", "Microsoft Azure", "Azure DevOps", "Azure Pipelines",
      "Azure App Service", "Azure Blob Storage", "Docker", "CI/CD",
      "Continuous Integration", "npm", "JWT", "OAuth 2.0",
      ...
      "Microservices", "Event-Driven Architecture", "Clean Architecture",
      "Agile Methoden", "Softwareentwicklung",
    ]),
  },
  {
    ...
    tech: techList([
      ...
      "JSON", "React", "Redux", "React Router", "Axios", "Fluent UI",
      "Komponentenbibliotheken", "Single Page Application (SPA)",
      ...
      "Instandhaltungsmanagement", "Prozessdigitalisierung", "Microsoft Azure",
      "Azure SQL", "Azure DevOps", "Docker", "CI/CD", "Continuous Integration",
      "npm", "Visual Studio", "Visual Studio Code", "Clean Architecture",
      "Agile Methoden", "Softwareentwicklung",
    ]),
  },
];
